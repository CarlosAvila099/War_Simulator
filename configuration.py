...
GROWTH_TIME = 1                 # Number of months required for a Continent to grow in population and income.
...
INCOME_THRESHOLD = .5           # The threshold that create an income trigger for an Inner Battle.
...
STALE_TIME = 15                 # The number of days needed for a Stale State to end a War.
